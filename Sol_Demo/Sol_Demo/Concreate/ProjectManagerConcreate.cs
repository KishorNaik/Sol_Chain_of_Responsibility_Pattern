...
{
    public class ProjectManagerConcreate : ILeaveRequestHandler<LeaveRequest>
    {
        ...
        void ILeaveRequestHandler<LeaveRequest>.Handle(LeaveRequest leaveRequest)
        {
            ...
            {
                Console.WriteLine("Leave request:- Employee: {0}, Leave days: {1} - approved by Project Manager", leaveRequest.EmployeeName, leaveRequest.LeaveDays);
            }
            else
            {
